...
The Shapiro test was used to check for normality.  The Bartlett test was used to check for homogeneity of variance.  Kruskal-Wallis was used in lieu of ANOVA due to lack of normality for all heavy metals in this dataset.  
