...
As_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#bebada", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) + annotate("text", x = 1:9, y = 325, label = c("277", "82", " ", "7", "12", "63", "14", "172", "454"))
...
#adds correct colors and number of obs. 
Cr_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#bebada", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) + geom_hline(yintercept=100, linetype="dashed", size=1.25) + annotate("text", x = 1:9, y = 300, label = c("277", "82", " ", "7", "12", "63", "14", "172", "454"))
...
#adds correct colors and number of obs. 
Ni_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#bebada", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) + geom_hline(yintercept=35, linetype="dashed", size=1.25) + annotate("text", x = 1:9, y = 300, label = c("277", "82", " ", "7", "12", "63", "14", "172", "454"))
##Line values from WHO permissible limits for heavy metals in plant and soil (1996)
...
metals.pca <- princomp(Log_metals, cor = FALSE, scores = TRUE)
...
autoplot(princomp(Main_matrix_metals), data=PCA_matrix, colour = "SAMPLE_SOURCE")
autoplot(princomp(Log_metals), data=PCA_matrix, colour = "SAMPLE_SOURCE")
