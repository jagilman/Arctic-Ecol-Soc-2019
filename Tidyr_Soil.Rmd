...
#log tranforming all metals data for display
...
As_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = -0.5, label = c("83", "188", "499", "18", "173")) + geom_hline(yintercept=1.505, linetype="dashed", size=1.25) + geom_hline(yintercept=0.8573, linetype="dashed", size=1.25, color="darkgrey") + stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") +ylim(-0.5,10) + annotate("text", x = 1:5, y = 10, label = c("b", "b", "b", "a", "c"))
...
As_depth + scale_fill_manual(values=c("#fee0d2", "#fc9272", "#de2d26")) + geom_hline(yintercept=1.505, linetype="dashed", size=1.25) + annotate("text", x = 1:3, y = -0.5, label = c("727", "153", "81")) + geom_hline(yintercept=0.8573, linetype="dashed", size=1.25, color="darkgrey") + stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") +ylim(-0.5,10) + annotate("text", x = 1:3, y = 10, label = c("b", "a", "b"))
...
Cr_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + geom_hline(yintercept=2, linetype="dashed", size=1.25) + annotate("text", x = 1:5, y = -0.5, label = c("83", "273", "524", "19", "173")) + geom_hline(yintercept=1.5682, linetype="dashed", size=1.25, color="darkgrey") + stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") + ylim(-0.5,10) + annotate("text", x = 1:5, y = 10, label = c("bc", "b", "c", "a", "bc"))
...
Cr_depth + scale_fill_manual(values=c("#fee6ce", "#fdae6b", "#e6550d")) + geom_hline(yintercept=2, linetype="dashed", size=1.25) + annotate("text", x = 1:3, y = -0.5, label = c("840", "153", "79"))+ geom_hline(yintercept=1.5682, linetype="dashed", size=1.25, color="darkgrey") + stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") + ylim(-0.5,10) + annotate("text", x = 1:3, y = 10, label = c("b", "a", "c"))
...
Hg_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = 10, label = c("83", "124", "411", "12", "170")) + stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") + ylim(-6,10) + annotate("text", x = 1:5, y = -6, label = c("b", "d", "c", "a", "c")) + geom_hline(yintercept=0.81954, linetype="dashed", size=1.25)
#Standard from the Canadian Council of Ministers of the Environment

###START HERE WHEN YOU RESUME ON 15 MAY
...
Hg_depth + scale_fill_manual(values=c("#e5f5e0", "#a1d99b", "#31a354")) + annotate("text", x = 1:3, y = -0.2, label = c("628", "159", "58")) + stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") + ylim(-.25,5) + geom_hline(yintercept=0.8195, linetype="dashed", size=1.25)
#Standard from the Canadian Council of Ministers of the Environment
