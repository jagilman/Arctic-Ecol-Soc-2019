...
Hg_plot + scale_fill_manual(values=c("#80b1d3", "#b3de69", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = -6, label = c("83", "124", "411", "12", "170")) + ylim(-6,10) + annotate("text", x = 1:5, y = 10, label = c("b", "d", "c", "a", "c")) + geom_hline(yintercept=1.887, linetype="dashed", size=0.75)
