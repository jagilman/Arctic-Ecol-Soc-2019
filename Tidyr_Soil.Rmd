...
ggplot(USGS_analyze, aes(SAMPLE_SOURCE, As_ppm)) + 
  geom_boxplot(aes(fill = SAMPLE_SOURCE)) +
...
ggplot(USGS_analyze, aes(SAMPLE_SOURCE, Cr_ppm)) + 
  geom_boxplot(aes(col = SAMPLE_SOURCE)) +
  xlab("source") +
  ylab("Cr (ppm)") +
   theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
...
ggplot(USGS_analyze, aes(SAMPLE_SOURCE, Hg_ppm)) + 
  geom_boxplot(aes(col = SAMPLE_SOURCE)) +
  xlab("source") +
  ylab("Hg (ppm)") +
   theme(axis.title.x=element_blank(),
...
ggplot(USGS_analyze, aes(SAMPLE_SOURCE, Ni_ppm)) + 
  geom_boxplot(aes(col = SAMPLE_SOURCE)) +
  xlab("source") +
  ylab("Ni (ppm)") +
   theme(axis.title.x=element_blank(),
