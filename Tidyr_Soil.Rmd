...
pca.matrix <- filter(USGS_analyze, is.na(USGS_analyze$As_ppm) == FALSE)
pca.matrix <- filter(USGS_analyze, is.na(USGS_analyze$Cr_ppm) == FALSE)
pca.matrix <- filter(USGS_analyze, is.na(USGS_analyze$Ni_ppm) == FALSE)
pca.matrix <- filter(USGS_analyze, is.na(USGS_analyze$Pb_ppm) == FALSE)

metals.pca <- prcomp(USGS_analyze[,c(14,16,18,20,22)], center = TRUE)
summary(metals.pca)
```
