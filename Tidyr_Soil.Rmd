...
#USGS_analyze$Hg_ppm<- na_if(USGS_analyze$Hg_ppm, 46400.00) value of 46400.00 ppm is order of mag higher than others... 
...
As_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = -0.5, label = c("83", "188", "499", "18", "173")) + geom_hline(yintercept=3.4657, linetype="dashed", size=0.75) + geom_hline(yintercept=1.974, linetype="dotted", size=0.75, color="black")  + annotate("text", x = 1:5, y = 10, label = c("b", "b", "b", "a", "c"))
...
As_depth + scale_fill_manual(values=c("#fee0d2", "#fc9272", "#de2d26")) + geom_hline(yintercept=3.4657, linetype="dashed", size=0.75) + annotate("text", x = 1:3, y = -0.5, label = c("727", "153", "81")) + geom_hline(yintercept=1.974, linetype="dotted", size=0.75, color="black")  +ylim(-0.5,10) + annotate("text", x = 1:3, y = 10, label = c("b", "a", "b"))
...
Cr_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + geom_hline(yintercept=4.605, linetype="dashed", size=0.75) + annotate("text", x = 1:5, y = -0.5, label = c("83", "273", "524", "19", "173")) + geom_hline(yintercept=3.611, linetype="dotted", size=0.75, color="black") + ylim(-0.5,10) + annotate("text", x = 1:5, y = 10, label = c("bc", "b", "c", "a", "bc"))
#+ stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") 
...
Cr_depth + scale_fill_manual(values=c("#fee6ce", "#fdae6b", "#e6550d")) + geom_hline(yintercept=4.605, linetype="dashed", size=0.75) + annotate("text", x = 1:3, y = -0.5, label = c("840", "153", "79"))+ geom_hline(yintercept=3.611, linetype="dotted", size=0.75, color="black") + ylim(-0.5,10) + annotate("text", x = 1:3, y = 10, label = c("b", "a", "c"))
# + stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") 
...
Hg_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = -6, label = c("83", "124", "411", "12", "170")) + ylim(-6,10) + annotate("text", x = 1:5, y = 10, label = c("b", "d", "c", "a", "c")) + geom_hline(yintercept=1.887, linetype="dashed", size=0.75)
...
Hg_depth + scale_fill_manual(values=c("#e5f5e0", "#a1d99b", "#31a354")) + annotate("text", x = 1:3, y = -6, label = c("591", "144", "65")) + ylim(-6,10) + geom_hline(yintercept=1.887, linetype="dashed", size=0.75) + annotate("text", x = 1:3, y = 10, label = c("b", "b", "a"))
#Standard from the Canadian Council of Ministers of the Environment
#+ stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") 
...
#adds correct colors, number of obs., lines for WHO limit/US avg, and post-hoc groups 
Ni_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + geom_hline(yintercept=3.555, linetype="dashed", size=0.75) + annotate("text", x = 1:5, y = -10, label = c("83", "273", "531", "19", "167")) + geom_hline(yintercept=3.6888, linetype="dotted", size=0.75, color="black")  + ylim(-0.5,10) + annotate("text", x = 1:5, y = 10, label = c("d", "a", "b", "a", "c"))
##Line values from WHO permissible limits for heavy metals in plant and soil (1996)
#+ stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white")
...
#adds correct colors and number of obs. 
Ni_depth + scale_fill_manual(values=c("#deebf7", "#9ecae1","#3182bd")) + geom_hline(yintercept=3.5553, linetype="dashed", size=0.75) + annotate("text", x = 1:3, y = -10, label = c("835", "153", "85"))  + geom_hline(yintercept=3.68880, linetype="dotted", size=0.75) + ylim(-0.5,10) + annotate("text", x = 1:3, y = 10, label = c("a", "b", "b"))
#+ stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") 
...
#adds correct colors, number of obs., lines for WHO limit/US avg, and post-hoc groups 
Pb_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + geom_hline(yintercept=4.4426, linetype="dashed", size=0.75) + annotate("text", x = 1:5, y = -0.5, label = c("83", "231", "581", "19", "167"))  + geom_hline(yintercept=3.401, linetype="dotted", size=0.75) + ylim(-0.5,10) + annotate("text", x = 1:5, y = 10, label = c("b", "b", "b", "a", "c"))
##Line values from WHO permissible limits for heavy metals in plant and soil (1996)
#+ stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") 
