...
Looking at distributions of metals data with basic boxplots, Cleveland dot plots, and histograms to look at distrubtions (commented out for now). Then nicers box plots to look at concentration by sample source.
Things to do for ASIAQ - overlay WHO (or EPA/other country...EU, New York state?) standard for soil conc, put n values for sample sources, clean up colors/configuration
```{r}
...
#creating a data matrix of sample sources and HEX codes to have consistent color scheme across plots 
...
color_code =c("#8dd3c7", "#ffffb3", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd"))


As_plot <- ggplot(USGS_analyze, aes(SAMPLE_SOURCE, As_ppm, fill=SAMPLE_SOURCE)) + 
   geom_boxplot() +
  xlab("source") +
  ylab("As (ppm)") +
...
As_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#bebada", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) 
...
Cr_plot <- ggplot(USGS_analyze, aes(SAMPLE_SOURCE, Cr_ppm, fill=SAMPLE_SOURCE)) + 
  geom_boxplot() +
  xlab("source") +
  ylab("Cr (ppm)") +
   theme(axis.title.x=element_blank(),
...
Cr_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#bebada", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) 
...
Hg_plot <- ggplot(USGS_analyze, aes(SAMPLE_SOURCE, Hg_ppm, fill=SAMPLE_SOURCE)) + 
  geom_boxplot() +
  xlab("source") +
  ylab("Hg (ppm)") +
   theme(axis.title.x=element_blank(),
...
Hg_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#80b1d3", "#b3de69", "#fccde5", "#bc80bd"))
...
Ni_plot <- ggplot(USGS_analyze, aes(SAMPLE_SOURCE, Ni_ppm, fill=SAMPLE_SOURCE)) + 
  geom_boxplot() +
  xlab("source") +
  ylab("Ni (ppm)") +
   theme(axis.title.x=element_blank(),
...
Ni_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#bebada", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) 
...
Pb_plot <- ggplot(USGS_analyze, aes(SAMPLE_SOURCE, Pb_log, fill=SAMPLE_SOURCE)) + 
   geom_boxplot() +
  xlab("source") +
  ylab("Pb (ppm)") +
   theme(axis.title.x=element_blank(),
...
Pb_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#bebada", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) 
