...
Now we need to convert units all to cm...work in progress...
```{r}
USGS5$UNIT <- as.character(USGS5$UNIT)
str(USGS5$UNIT)
...
USGS5$TOP <- ifelse(USGS5$UNIT = "in", USGS5$UPPER*2.54, USGS5$UPPER*1)
