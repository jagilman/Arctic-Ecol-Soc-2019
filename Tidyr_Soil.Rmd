...
As_plot + scale_fill_manual(values=c("#80b1d3", "#b3de69", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = -0.5, label = c("83", "188", "499", "18", "173")) + geom_hline(yintercept=3.4657, linetype="dashed", size=0.75) + geom_hline(yintercept=1.974, linetype="dotted", size=0.75, color="black")  + annotate("text", x = 1:5, y = 10, label = c("b", "b", "b", "a", "c"))
...
Cr_plot + scale_fill_manual(values=c("#80b1d3", "#b3de69", "#fdb462", "#fb8072", "#bebada")) + geom_hline(yintercept=4.605, linetype="dashed", size=0.75) + annotate("text", x = 1:5, y = -0.5, label = c("83", "273", "524", "19", "173")) + geom_hline(yintercept=3.611, linetype="dotted", size=0.75, color="black") + ylim(-0.5,10) + annotate("text", x = 1:5, y = 10, label = c("bc", "b", "c", "a", "bc"))
#+ stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") 
...
Hg_plot + scale_fill_manual(values=c("#80b1d3", "#b3de69", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = -6, label = c("83", "124", "411", "12", "170")) + ylim(-6,10) + annotate("text", x = 1:5, y = 10, label = c("b", "d", "c", "a", "c")) + geom_hline(yintercept=1.887, linetype="dashed", size=0.75) + geom_hline(yintercept=-3.5404, linetype="dotted", size=0.75, color="black")
...
Hg_depth + scale_fill_manual(values=c("#e5f5e0", "#a1d99b", "#31a354")) + annotate("text", x = 1:3, y = -6, label = c("591", "144", "65")) + ylim(-6,10) + geom_hline(yintercept=1.887, linetype="dashed", size=0.75) + annotate("text", x = 1:3, y = 10, label = c("b", "b", "a")) + geom_hline(yintercept=-3.5404, linetype="dotted", size=0.75, color="black")
#Standard from the Canadian Council of Ministers of the Environment
#+ stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white") 
...
#adds correct colors, number of obs., lines for WHO limit/US avg, and post-hoc groups 
Ni_plot + scale_fill_manual(values=c("#80b1d3", "#b3de69", "#fdb462", "#fb8072", "#bebada")) + geom_hline(yintercept=3.555, linetype="dashed", size=0.75) + annotate("text", x = 1:5, y = -10, label = c("83", "273", "531", "19", "167")) + geom_hline(yintercept=3.6888, linetype="dotted", size=0.75, color="black")  + ylim(-0.5,10) + annotate("text", x = 1:5, y = 10, label = c("d", "a", "b", "a", "c"))
##Line values from WHO permissible limits for heavy metals in plant and soil (1996)
#+ stat_summary(fun.y=mean, geom="point", shape=23, size=3, color="black", fill="white")
...
#returns 0.5479 (OLD)
# NEW: 0.0375
#Calculates the proportion of values greater than the median value for soils in the Western United States (1.08 mg/kg; from Obrist et al., 2016)
