...
```{r}
#Counts for annotation
Hg_count <- select(USGS_analyze, Source, TOP_CM, Hg_ppm)
...
Ni_count <- select(USGS_analyze, Source, TOP_CM, Ni_ppm)
...
Pb_count <- select(USGS_analyze, Source, TOP_CM, Pb_ppm, Pb_log)
