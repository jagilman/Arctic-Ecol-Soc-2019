...
As_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = 325, label = c("277", "82", "531", "19", "172"))  + geom_hline(yintercept=7.2, linetype="dashed", size=1.25, color="darkgrey")
...
#adds correct colors and number of obs. 
Cr_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + geom_hline(yintercept=100, linetype="dashed", size=1.25) + annotate("text", x = 1:5, y = 300, label = c("277", "82", "531", "19", "172")) + geom_hline(yintercept=37, linetype="dashed", size=1.25, color="darkgrey")
...
#adds correct colors and number of obs. 
Hg_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + annotate("text", x = 1:5, y = 100, label = c("139", "82", "440", "12", "172"))
...
#adds correct colors and number of obs. 
Ni_plot + scale_fill_manual(values=c("#b3de69", "#80b1d3", "#fdb462", "#fb8072", "#bebada")) + geom_hline(yintercept=35, linetype="dashed", size=1.25) + annotate("text", x = 1:5, y = 300, label = c("277", "82", "531", "19", "172")) + geom_hline(yintercept=40, linetype="dashed", size=1.25, color="darkgrey")
##Line values from WHO permissible limits for heavy metals in plant and soil (1996)
