...
USGS_analyze$Source <- recode(USGS_analyze$Source, "surface"  = "sedge/grassland")
...
As_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) + annotate("text", x = 1:9, y = 325, label = c("277", "82", " ", "7", "12", "63", "14", "172", "454"))  + geom_hline(yintercept=7.2, linetype="dashed", size=1.25, color="darkgrey")
...
#adds correct colors and number of obs. 
Cr_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) + geom_hline(yintercept=100, linetype="dashed", size=1.25) + annotate("text", x = 1:9, y = 300, label = c("277", "82", " ", "7", "12", "63", "14", "172", "454")) + geom_hline(yintercept=37, linetype="dashed", size=1.25, color="darkgrey")
...
#adds correct colors and number of obs. 
Ni_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) + geom_hline(yintercept=35, linetype="dashed", size=1.25) + annotate("text", x = 1:9, y = 300, label = c("277", "82", " ", "7", "12", "63", "14", "172", "454")) + geom_hline(yintercept=40, linetype="dashed", size=1.25, color="darkgrey")
##Line values from WHO permissible limits for heavy metals in plant and soil (1996)
...
#adds correct colors and number of obs. 
Pb_plot + scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#bebada", "#fb8072", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#bc80bd")) + geom_hline(yintercept=1.9294, linetype="dashed", size=1.25) + annotate("text", x = 1:9, y = 3.25, label = c("231", "82", "68", "7", "12", "53", "14", "166", "447"))  + geom_hline(yintercept=1.477, linetype="dashed", size=1.25, color="darkgrey")
##Line values from WHO permissible limits for heavy metals in plant and soil (1996)
