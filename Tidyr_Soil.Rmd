...
#this parses out the top and bottom depth as is - now need to ammend to get the units in a third column
USGS5 <- separate(USGS4, col="DEPTH", c("UPPPER", "LOWER"), sep = '-') %>% mutate_at(vars("UPPPER", "LOWER"), parse_number)
